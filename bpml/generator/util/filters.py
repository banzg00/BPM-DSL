...
from bpml.language.builtins import simple_type_java_mapper, simple_type_typescript_mapper
...
def format_type_java(obj_type):
    ...
    return simple_type_java_mapper.get(type_name, type_name)
...
def format_type_typescript(obj_type):
    ...
    """
    type_name = obj_type if isinstance(obj_type, str) else str(obj_type)
    return simple_type_typescript_mapper.get(type_name, type_name)
...
def is_simple_type(data_type):
    ...
    return type_str in simple_type_java_mapper.keys()
